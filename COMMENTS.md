...
I did not take the time to organise my styles here as I was doing a lot of exploratory work.

On top of this, I took this exercise as a prototyping UX/UI exercise more than a production build.
...
In a real world application, I would have preferred a SSR framework: there is no clear benefits in loading the client side for this type of application.

## Lack of 'share' functionality

In the preparation work, I mention the necessity to add a share functionality.
I haven't implemented it. It could be easily implemented by having a `useEffect` hook in the `router` check for any query parameters in the url, and redirecting accordingly.

Or, even better, move to a MPA and eliminate the issue altogether.

## Lack of testing

My main goal here was UI and UX, and I have done implemented very little testing as the application is quite simple and I have done a lot of manual testing.

However, I would strongly advocate for at least a proper E2E suite using Cypress or something similar.

We could easily add some unit testing, but I do think E2E would be fairly quick to write and provide a lot more confidence.
...
In a real-world situation, I would advocate turning it into a video or hosting the assets rather than fetching them on demand.
...
I took the decision to use a global context.
...
This includes identifying use case, planning the work to be conducted and general comments as I progressed.
