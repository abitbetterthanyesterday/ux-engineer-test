...
export function Logo() {
   ...
   return (
      <div className="flex flex-col items-center gap-1 hover:scale-[1.03] cursor-pointer transition" onClick={reset}>
...
export function LogoSmall() {
   const { reset } = useSearchShow()
   return (
      <div className="flex flex-col items-center gap-1 cursor-pointer transition hover:scale-[1.03]" onClick={reset}>
