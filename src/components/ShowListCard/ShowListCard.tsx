         ...
         >
            {show.image ? (
               <img
                  ...
                  alt=''
                  className={`h-full transition duration-1000 rounded-lg group-hover:scale-105`}
               />
            ) : (
               <p className='text-sm tracking-wider uppercase text-indigo-50/50 group-hover:scale-105'>
                  No preview available
               </p>
            )}
         </div>
         <h3 className='max-w-full pt-4 font-semibold text-center uppercase transition group-hover:underline group-hover:text-indigo-500 overflow-ellipsis'>
            {show.name}
         </h3>
      </li>
   )
