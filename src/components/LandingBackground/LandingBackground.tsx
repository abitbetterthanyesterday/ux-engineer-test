...
function LandingBackground(): JSX.Element {
   ...
   return (
      <div className='absolute z-10 w-screen h-screen overflow-hidden animate-fadeIn'>
         <div className='absolute flex w-[120vh] h-full min-w-full gap-6 overflow-hidden bg-indigo-950 bg-gradient-to-t from-gray-900 via-slate-950 to-indigo-950 -z-10 -ml-[55px]'>
