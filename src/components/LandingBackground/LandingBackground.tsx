...
function LandingBackground(): JSX.Element {
    ...
    if(process.env.NODE_ENV === 'test'){
      return <></>
         ...
         return (
         <div className="absolute flex w-screen h-full min-w-full gap-6 overflow-hidden bg-indigo-950 bg-gradient-to-t from-gray-900 via-slate-950 to-indigo-950 -z-10">
