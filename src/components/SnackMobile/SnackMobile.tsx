...
export function SnackMobile() {
   ...
   return (
      <div
         className={`absolute z-50 flex flex-col gap-4  py-4 px-4 ml-4 text-indigo-100 border border-indigo-500 rounded-lg bg-indigo-800/95 top-2 right-2 transition ${
